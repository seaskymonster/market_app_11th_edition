...
<script>
         function categorysubmit(){
			 ...
			 if(validateradiobutton(document.f1.deletechoose)==false){
			   errormessage+="Please select a category to delete.<br>";
			  }
			 if(errormessage==''){
			    document.f1.submit();
			 }else{
		 ...
		 function productsubmit(){
			 ...
			 if(validateradiobutton(document.f2.deletechoose)==false){
			   errormessage+="Please select a product to delete.<br>";
			  }
			 if(errormessage==''){
			    document.f2.submit();
			 }else{
		     ...
		     errormessage="";
			 if(validateradiobutton(document.f3.deletechoose)==false){
			   errormessage+="Please select a specialsale to delete.<br>";
			  }
			 if(errormessage==''){
			    document.f3.submit();
			 }else{
...
<body>
     <?php
		  ...
		  $url="saleoperation.php?type=delete&tabletype=$tabletype";
					...
					<?php
					  $sql = "select * from productcategory";
						...
						<tr>
							";
						    echo"<td>
							        <input type='radio'name='deletechoose' value='".$row['productcategoryID']."'>
								 </td>";
					...
					<?php
					  $sql = "select * from product";
						...
						<tr>
							";
						    echo"<td>
							        <input type='radio'name='deletechoose' value='".$row['productID']."'>
								 </td>";
					...
					<?php
					  $sql = "select * from specialsale";
						...
						<tr>
							";
						    echo"<td>
							        <input type='radio'name='deletechoose' value='".$row['specialsaleID']."'>
								 </td>";
