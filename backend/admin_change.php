      ...
      <script>
	     function usersubmit(){
				   ...
				   if(validateradiobutton(document.f1.changechoose)==false){
					...
					errormessage+="Please select an user to change";
				   }
        ...
        function employeesubmit(){
				 ...
				 if(validateradiobutton(document.f2.changechoose)==false){
				      errormessage+="Please select an employee to change";
				 }
				 if(errormessage==''){
				      document.f2.submit();
				 } else{ 
...
<body>
     <?php 
	   ...
	   $url="admin_change2.php?tabletype=$tabletype";
       if($tabletype=='user'){
      ?>
          <h2>Change a user</h2>
               ...
               <table>
				...
				<?php
				  ...
				  while($row=mysql_fetch_assoc($result)){
				     echo"
					     <tr>";
					 echo"<td><input type='radio'name='changechoose' value='".$row['userID']."'>
					      </td>";
				  ...
				  if(!$con){
				   ...
				   while($row=mysql_fetch_assoc($result)){
				         echo"
							 ...
							 ";
						echo"<td>
						    <input type='radio' name='changechoose' value='".$row['employeeID']."'>
							</td>";
